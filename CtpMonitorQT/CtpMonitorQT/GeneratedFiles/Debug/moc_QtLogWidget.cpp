...
void QtLogWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QtLogWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QtLogWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtLogWidget::appendlog)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QtLogWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QtLogWidget.data,
    qt_meta_data_QtLogWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
